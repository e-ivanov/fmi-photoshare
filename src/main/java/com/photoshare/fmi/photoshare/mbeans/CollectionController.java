...
import com.photoshare.fmi.photoshare.ejb.CollectionFacade;
import com.photoshare.fmi.photoshare.ejb.CollectionFacadeLocal;
import com.photoshare.fmi.photoshare.entity.Collection;
import com.photoshare.fmi.photoshare.mbeans.util.JsfUtil;
import com.photoshare.fmi.photoshare.mbeans.util.PaginationHelper;
...
public class CollectionController implements Serializable {
    ...
    @EJB
    private CollectionFacadeLocal ejbFacade;
    ...
    private CollectionFacadeLocal getFacade() {
        return ejbFacade;
    }
